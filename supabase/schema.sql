...
create table cost_assumptions (
  ...
  -- Selling Expenses (replaces legal_fees_pct and early_bird_pct)
  vip_discount_pct            numeric(6,2)  default 9,
  additional_sales_pkg_pct    numeric(6,2)  default 0.5,
  commission_brokerage_pct    numeric(6,2)  default 2,
  repeat_buyers_pct           numeric(6,2)  default 0.2,
  spa_legal_fees_per_unit     numeric(10,2) default 5500,
  director_staff_discount_pct numeric(6,2)  default 0.15,
  bumi_penalty_per_unit       numeric(12,2) default 50000,
  maintenance_fund_rate_psf   numeric(8,4)  default 0.70,
